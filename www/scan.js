module.exports = {
  scanDoc: function (successCallback, errorCallback, options) {
    options = options || {};
    options.sourceType =
      options.sourceType == undefined ? 1 : options.sourceType;
    options.fileName =
      options.fileName == undefined ? "image" : options.fileName;
    options.quality =
      !isNaN(options.quality) && options.quality >= 1 && options.quality <= 5
        ? options.quality
        : 1;
    options.returnBase64 =
      typeof options.returnBase64 === "boolean" ? options.returnBase64 : false;
    if (
      (options.sourceType === 1 || options.sourceType === 0) &&
